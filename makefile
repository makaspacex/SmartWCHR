...
DC_PACKAGES = swc_nav_bringup costmap_converter_msgs costmap_converter fake_vel_transform nav2_sample swc_navigation teb_msgs teb_local_planner gesture_recognition_msgs gesture_recognition  imu_complementary_filter lidars_sync_fusion linefit_ground_segmentation linefit_ground_segmentation_ros pcl_filter pointcloud_to_laserscan livox_laser_simulation_RO2 pb_swc_simulation
