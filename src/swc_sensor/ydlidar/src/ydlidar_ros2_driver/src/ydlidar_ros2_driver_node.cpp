...
int main(int argc, char *argv[])
{
  ...
  // auto node = rclcpp::Node::make_shared("ydlidar_ros2_driver_node"); // --cyq debug
  // 新代码（ROS 2 Humble 正确写法）
  auto node = std::make_shared<rclcpp::Node>("ydlidar_ros2_driver", rclcpp::NodeOptions());
  ...
  node->declare_parameter<int>("baudrate", 512000);
  ...
  // node->declare_parameter("invalid_range_is_inf"); // --cyq debug
