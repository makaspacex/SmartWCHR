...
int main(int argc, char **argv)
{
  ...
  auto node = std::make_shared<rclcpp::Node>("lidar_ms200"); // create a ROS2 Node
  ...
  rclcpp::Publisher<sensor_msgs::msg::LaserScan>::SharedPtr publisher = node->create_publisher<sensor_msgs::msg::LaserScan>(scan_topic, 1);
