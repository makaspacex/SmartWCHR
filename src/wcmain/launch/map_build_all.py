...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            IncludeLaunchDescription(os.path.join(get_package_share_directory("ros_local"), "launch", "localization.py")),
             IncludeLaunchDescription(os.path.join(get_package_share_directory("slam_2d"), "launch", "slam2d.py")),
