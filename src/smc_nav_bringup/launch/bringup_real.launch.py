...
def generate_launch_description():
    ...
    get_package_share_directory('smc_nav_bringup'), 'config', 'reality', 'measurement_params_real.yaml')))
    robot_description = Command(['xacro ', os.path.join(
    get_package_share_directory('smc_nav_bringup'), 'urdf', 'sentry_robot_real.xacro'),
    ...
    segmentation_params = os.path.join(smc_nav_bringup_dir, 'config', 'reality', 'segmentation_real.yaml')
    ########################## linefit_ground_segementation parameters end ############################

    #################################### FAST_LIO parameters start ####################################
    fastlio_mid360_params = os.path.join(smc_nav_bringup_dir, 'config', 'reality', 'fastlio_mid360_real.yaml')
    fastlio_rviz_cfg_dir = os.path.join(smc_nav_bringup_dir, 'rviz', 'fastlio.rviz')
    ##################################### FAST_LIO parameters end #####################################

    ################################### POINT_LIO parameters start ####################################
    pointlio_mid360_params = os.path.join(smc_nav_bringup_dir, 'config', 'reality', 'pointlio_mid360_real.yaml')
    ...
    slam_toolbox_localization_file_dir = os.path.join(smc_nav_bringup_dir, 'config', 'reality', 'mapper_params_localization_real.yaml')
    slam_toolbox_mapping_file_dir = os.path.join(smc_nav_bringup_dir, 'config', 'reality', 'mapper_params_online_async_real.yaml')
    ...
    nav2_params_file_dir = os.path.join(smc_nav_bringup_dir, 'config', 'reality', 'nav2_params_real.yaml')
    ...
    pointcloud_downsampling_config_dir = os.path.join(smc_nav_bringup_dir, 'config', 'reality', 'pointcloud_downsampling_real.yaml')
    ############################# pointcloud_downsampling parameters start ############################
